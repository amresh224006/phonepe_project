...
if select == "Home":
    ...
    with col2:
        st.video(r"C:\Users\ak408\youtube\phonepe\PhonePe Motion Graphics.mp4")

    col3,col4= st.columns(2)
    
    with col3:
        st.image(Image.open(r"C:\Users\ak408\youtube\phonepe\th (1).jpeg"),width=300)
    ...
    with col6:
        st.image(Image.open((r"C:\Users\ak408\youtube\phonepe\th2.jpeg")),width=600)
